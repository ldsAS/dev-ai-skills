...
- **AI 技能庫 (Skills)**：`.agents/skills/`（Antigravity 2.0 專案層）, `.agent/skills/`（1.x 專案層）, `.gemini/skills/`, `.claude/skills/`, `~/.gemini/config/skills/`（2.0 全域）, `~/.gemini/antigravity/skills/`（1.x 全域）等目錄。
