...
# 專案層自訂子代理定義；agy 1.0.13 的 agents 與 skills 建立路徑函式完全對稱，
# 執行期狀態另有去處，故視同 .claude/agents/ 放行（C-54）
!.agents/agents/
!.agents/plugins/
.agents/plugins/*
