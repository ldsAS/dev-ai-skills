...
**最後更新**：2026-09-11（Issue #12 的 2026-09-11 追加訊號判定為文件範例 —— C-04 補佐證；新增 C-100：單段主張路徑不被深層 token 往上命中；C-101：跨來源存在性註記；C-102：涵蓋率改用同一套比對規則，**盲區由 2 條修正為 7 條**）
