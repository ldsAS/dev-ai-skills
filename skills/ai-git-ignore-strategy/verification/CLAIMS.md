...
**最後更新**：2026-09-10（Issue #12 判定為語彙假陽性 —— 新增 C-97：monorepo 子目錄的 `.claude/settings.local.json` 未被範本涵蓋；C-98：前導斜線正規化；C-99：單段 token 不再向下扇出）
